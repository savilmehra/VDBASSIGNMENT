...
public class TinyDB {
   ...
   /* public Object getObjectJackson(String key, Class<?> classOfT) {
        ObjectMapper objectMapper = new ObjectMapper();
        String json = getString(key);
        Object value = null;
        try {
            value = objectMapper.readValue(json,classOfT);
        } catch (Exception e) {
    ...
    /*public void putObjectJackson(String key, Object obj) {
        try {
            checkForNullKey(key);
            ObjectMapper objectMapper = new ObjectMapper();
            putString(key, objectMapper.writeValueAsString(obj));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }*/
